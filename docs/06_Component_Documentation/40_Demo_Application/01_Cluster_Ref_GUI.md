...
If you want to control behavior by CAN signals, you need to change the running mode of the cluster service from demo to CAN.  It is set by /lib/systemd/system/cluster-service.service.
